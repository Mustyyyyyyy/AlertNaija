...
exports.sendResetPasswordEmail = async (email, token) => {
  const resetUrl = `${process.env.CLIENT_URL.split(',')[0]}/reset/${token}`;
  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px;">
        <h2 style="color: #FF3366; text-align: center;">AlertNaija</h2>
        <p>Hello,</p>
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="${resetUrl}" style="background-color: #FF3366; color: white; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold;">Reset Password</a>
        </div>
