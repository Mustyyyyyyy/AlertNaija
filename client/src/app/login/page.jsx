...
export default function LoginPage() {
  ...
  /* ── STEP 1 : Location permission dialog ── */
  if (step === 1) {
    return (
      <main className="min-h-screen bg-background-dark flex items-center justify-center px-4">
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="space-y-5">
            {stateKnown ? (
              ...
              <p className="text-slate-400 text-sm text-center">We couldn&apos;t auto-detect your state — please select it below.</p>
            )}
            ...
            {stateKnown && (
              <div className="flex items-start gap-3 p-3 bg-emerald-500/10 border border-emerald-500/20 rounded-xl">
                ...
                <label htmlFor="auto-ok" className="text-sm text-slate-300">
                  <span className="text-white font-semibold">{detectedState}</span> looks right — save and continue
                </label>
              </div>
            )}
          ...
          <div className="mt-8 space-y-3">
            ...
            >
              {savingLoc ? "Saving…" : "Go to Dashboard"}
            </button>
            <button
              onClick={() => setStep(3)}
  ...
  /* ── STEP 3 : Location denied / skipped ── */
  return (
    <main className="min-h-screen bg-background-dark flex items-center justify-center px-4">
      <div className="w-full max-w-sm text-center">
